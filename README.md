...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <link href="odometer-theme-car.css" rel="stylesheet" type="text/css"/>
...
<script>
    setTimeout(function(){
    odometer.innerHTML = 1979;
}, 1000);

setTimeout(function(){
    odometer1.innerHTML = 473739;
}, 1000);

setTimeout(function(){
    odometer2.innerHTML = 3279;
}, 1000);

setTimeout(function(){
    odometer3.innerHTML = 1911;
}, 1000);
  ...
  #section1 {padding-top:50px;height:500px auto;clear:left;}
  #section2 {padding-top:50px;height:500px auto;background-color: #3352AD ;clear:left;color: #fff}
  #section3 {padding-top:50px;height:500px auto;color: #000; background-color: #eee;padding: 10px;}
  #section41 {padding-top:50px;height:500px auto;color: #fff; background-color: #00bcd4;}
  #section42 {padding-top:50px;height:500px auto;color: #fff; background-color: #009688;}
  </style>
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="50" style="margin: 0;">
  ...
  <div class="row">
             <div class="col-sm-4" style="height:250px;padding: 10px; padding: 2em;">
              ...
              <div class="col-sm-4" style="height:250px;margin:0px;">
                  <img src="Three-trucks-on-blue-background-1200x750.jpg" alt="" style="height: 250px;width: 430px"/>
